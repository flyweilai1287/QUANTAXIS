...
cn_en_compare = {'明细': 'id',
                 ...
                 '总资产':'total_asset',
                 '资金余额':'balance_money',
                '可取金额':'cash_out_money', #财通客户端 20191124
                '可用金额':'available_money', #财通客户端 20191124
                '股票市值':'lastest_mv', #财通客户端 20191124
                #####
                 '交易所代码':'market_code',
                 '帐号类别':'account_type',
...
trade_towards_cn_en = {
    ...
    '买入已撤': ORDER_DIRECTION.BUY,
    '卖出': ORDER_DIRECTION.SELL,
    '卖出已撤': ORDER_DIRECTION.SELL,
